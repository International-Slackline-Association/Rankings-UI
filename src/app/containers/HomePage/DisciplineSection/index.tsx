  ...
  return (
    <Wrapper>
      <DisciplineWrapper>
        ...
        <Divider />
        <DisciplineGroup>
          <DisciplineButton value={'3'} text={'Trickline Jib Static'} />
          <DisciplineButton value={'4'} text={'Trickline Transfer'} />
          <DisciplineButton value={'8'} text={'Speedline Long'} />
...
const Wrapper = styled.div`
  ...
  background: ${props =>
    `linear-gradient(35deg, ${props.theme.primaryDarker} 30%, ${props.theme.primaryLightest} 100%)`};
  color: ${props => props.theme.textInverted};
