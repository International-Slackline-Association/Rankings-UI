...
import { elevatedShadow } from 'styles/mixins';
import isaSportLogo from './isaSportLogo.svg';
    ...
    <Wrapper>
      ...
      <CenterWrapper>
        ...
        <ButtonWrapper>
          ...
          <SmallButton as={Link} to={'/contests'}>
            Contest List
          </SmallButton>
        </ButtonWrapper>
      </CenterWrapper>
...
const SmallButton = styled(LinkButton)<{ isPrimaryColor?: boolean }>`
  ${elevatedShadow};
  border-radius: 4px;
