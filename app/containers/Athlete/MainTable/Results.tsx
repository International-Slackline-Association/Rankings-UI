    ...
    tbody {
      ...
      tr {
        ...
        td {
          ...
          margin-bottom: 12px;
          font-size: 1.25rem;
          &:nth-child(1) { &::before { content: "${(props: WrapperProps) => props.dateMsg} :"; }}
          &:nth-child(2) { &::before { content: "${props => props.nameMsg} : "; }}
          &:nth-child(3) { &::before { content: "${props => props.disciplineMsg} : "; }}
          &:nth-child(4) { &::before { content: "${props => props.rankMsg} : "; }}
          &:nth-child(5) { &::before { content: "${props => props.sizeMsg} : "; }}
          &:nth-child(6) { &::before { content: "${props => props.countryMsg} : "; }}
          &::before {
            display: block;
            text-transform: uppercase;
            font-size: 12px;
