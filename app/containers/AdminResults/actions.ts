...
export const setAthleteFilterSelectedValue = (option: ISelectOption, index: number) =>
  action(ActionTypes.SET_ATHLETE_FILTER_SELECTED_VALUE, { value: option, index: index});
